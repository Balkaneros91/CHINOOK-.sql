...
antonio_claudio_andelic = Programmer(
    first_name="Antonio-Claudio",
    last_name="Andelic",
    gender="M",
...
# session.add(antonio_claudio_andelic)
...
#     confirmation = input("Are you sure you want to delete thsi record?
#                          (y/n) ")
#     if confirmation == "y":
...
# delete multiple or all records ######################### DEMONSTRATION
# PURPOSEs ONLY !!!
